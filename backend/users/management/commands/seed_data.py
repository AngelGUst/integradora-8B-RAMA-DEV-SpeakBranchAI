    ...
    def _create_questions(self, created_by):
        question_seed = [
            ...
            },
            {
                ...
                'level': 'A1',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "Choose the correct greeting: Good ___", "options": ["night", "morning", "late", "slow"], "correct": "morning"}]}',
                'difficulty': 'EASY',
                'max_replays': None,
            },
            {
            ...
            },
            {
                ...
                'level': 'A1',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "Pick the word you heard.", "options": ["confidence", "journey", "focus"], "correct": "confidence"}]}',
                'phonetic_text': 'Listen carefully: confidence. This word means belief in your abilities.',
                'difficulty': 'MEDIUM',
                'max_replays': 3,
            },
            {
            ...
            },
            {
                ...
                'level': 'A2',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "Identify the key word.", "options": ["progress", "strategy", "resolve"], "correct": "progress"}]}',
                'phonetic_text': 'The key word is progress. Progress means moving forward toward a goal.',
                'difficulty': 'MEDIUM',
                'max_replays': 3,
            },
            {
                'text': 'Choose the correct verb: "She ___ coffee every morning."',
                'type': 'READING',
                'level': 'A1',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "She ___ coffee every morning.", "options": ["drink", "drinks", "drank"], "correct": "drinks"}]}',
                'difficulty': 'EASY',
                'max_replays': None,
            },
            {
                'text': 'Repeat the phrase: "I enjoy learning English."',
                'type': 'LISTENING_SHADOWING',
                'level': 'A2',
                'category': 'DIAGNOSTIC',
                'correct_answer': 'I enjoy learning English.',
                'difficulty': 'MEDIUM',
                'max_replays': None,
            },
            {
                'text': 'Introduce your hometown in two sentences.',
                'type': 'SPEAKING',
                'level': 'A2',
                'category': 'DIAGNOSTIC',
                'correct_answer': 'Any clear introduction about hometown is accepted.',
                'difficulty': 'MEDIUM',
                'max_replays': None,
            },
            {
                'text': 'Listen and select the correct meaning.',
                'type': 'LISTENING_COMPREHENSION',
                'level': 'B1',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "Select the correct meaning.", "options": ["goal", "result", "problem"], "correct": "goal"}]}',
                'phonetic_text': 'The word means goal. Select the option that matches the meaning: goal.',
                'difficulty': 'MEDIUM',
                'max_replays': 3,
            },
            {
                'text': 'Choose the best summary sentence.',
                'type': 'READING',
                'level': 'B1',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "Best summary.", "options": ["Short summary", "Long summary", "Unrelated"], "correct": "Short summary"}]}',
                'difficulty': 'MEDIUM',
                'max_replays': None,
            },
            {
                'text': 'Explain a recent achievement and its impact.',
                'type': 'SPEAKING',
                'level': 'B1',
                'category': 'DIAGNOSTIC',
                'correct_answer': 'Any clear achievement + impact is accepted.',
                'difficulty': 'HARD',
                'max_replays': None,
            },
            {
                'text': 'Write a short paragraph about a future plan.',
                'type': 'WRITING',
                'level': 'B1',
                'category': 'DIAGNOSTIC',
                'correct_answer': 'Any coherent paragraph about a future plan is accepted.',
                'difficulty': 'HARD',
                'max_replays': None,
            },
            {
                'text': 'Shadow the sentence: "Clear structure improves clarity."',
                'type': 'LISTENING_SHADOWING',
                'level': 'B2',
                'category': 'DIAGNOSTIC',
                'correct_answer': 'Clear structure improves clarity.',
                'difficulty': 'HARD',
                'max_replays': None,
            },
            {
                'text': 'Select the most accurate inference.',
                'type': 'READING',
                'level': 'B2',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "Most accurate inference.", "options": ["Inference A", "Inference B", "Inference C"], "correct": "Inference B"}]}',
                'difficulty': 'HARD',
                'max_replays': None,
            },
            {
                ...
                'level': 'B2',
                'category': 'DIAGNOSTIC',
                'correct_answer': '{"questions": [{"text": "Comprehension question.", "options": ["Option 1", "Option 2", "Option 3"], "correct": "Option 2"}]}',
                'phonetic_text': 'Choose the correct answer based on the audio. The best option is Option 2.',
                'difficulty': 'HARD',
                'max_replays': 3,
            },
            {
                'text': 'Write a concise summary of a professional email.',
                'type': 'WRITING',
                'level': 'B2',
                'category': 'DIAGNOSTIC',
                'correct_answer': 'Any concise professional summary is accepted.',
                'difficulty': 'HARD',
                'max_replays': None,
            },
            {
                'text': 'Deliver a short opinion on a modern topic.',
                'type': 'SPEAKING',
                'level': 'C1',
                'category': 'DIAGNOSTIC',
                'correct_answer': 'Any clear opinion with reasoning is accepted.',
                'difficulty': 'HARD',
                'max_replays': None,
            },
            {
            ...
            },
            {
                ...
                'level': 'B1',
                'category': 'PRACTICE',
                'correct_answer': '{"questions": [{"text": "Select the best summary.", "options": ["summary", "detail", "opinion", "topic"], "correct": "summary"}]}',
                'difficulty': 'MEDIUM',
                'max_replays': None,
            },
            {
            ...
            },
            {
                ...
                'level': 'B2',
                'category': 'LEVEL_UP',
                'correct_answer': '{"questions": [{"text": "Choose the best inference.", "options": ["inference", "detail", "fact", "guess"], "correct": "inference"}]}',
                'difficulty': 'HARD',
                'max_replays': None,
            },
            {
                ...
                'level': 'B2',
                'category': 'LEVEL_UP',
                'correct_answer': '{"questions": [{"text": "Comprehension question.", "options": ["insight", "clarity", "focus"], "correct": "insight"}]}',
                'phonetic_text': 'Select the correct answer based on the audio. The correct option is insight.',
                'difficulty': 'HARD',
                'max_replays': 3,
            },
        ]
